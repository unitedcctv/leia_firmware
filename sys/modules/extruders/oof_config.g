...
; Input Parameters:
;	None - hardcoded for T0 (single extruder)
; Example:
;	M98 P"/sys/modules/extruders/oof_config.g"
;------------------------------------------------------------------------------
var CURRENT_FILE = "/sys/modules/extruders/oof_config.g"
...
var CAN_ID_NAME			= "20"						; As a string
var SENSOR_PORT_OOF		= {var.CAN_ID_NAME^"."^var.SENSOR_INPUT}	; OOF Sensor port
var SENSOR_NAME_OOF 	= "oof_t0[mV]"			; Name used to idenfity the OOF sensor

var SENSOR_PORT_RETMOD	= {var.CAN_ID_NAME^"."^var.SENSOR_INPUT_RETMOD}	; Retraction module sensor port
var SENSOR_NAME_RETMOD 	= "retract_mod_t0[mV]"	; Name used to idenfity the retraction module sensor
; Range
...
; Create the input ------------------------------------------------------------
M950 J{global.OOF_INPUTS_ID[var.TOOL]} C{"!"^var.SENSOR_PORT_OOF} T{var.TRIGGERING_POINT}
M98 P"/macros/assert/result.g" R{result} Y"Unable to create the analog OOF input" F{var.CURRENT_FILE} E12656
;M950 J{global.OOF_INPUTS_ID_RETMOD[var.TOOL]} C{"!"^var.SENSOR_PORT_RETMOD} T{var.TRIGGERING_POINT}
...
M581 P{global.OOF_INPUTS_ID[var.TOOL]} T{global.OOF_INPUTS_TRIGGER[var.TOOL][0]} S1	;Configure the emergency trigger event
...
M581 P{global.OOF_INPUTS_ID[var.TOOL]} T{global.OOF_INPUTS_TRIGGER[var.TOOL][1]} 	S0	;Configure the emergency trigger event
...
;M581 P{global.OOF_INPUTS_ID_RETMOD[var.TOOL]} T{global.OOF_INPUTS_RETMOD_TRIGGER[var.TOOL][0]} S1	;Configure the emergency trigger event
...
;M581 P{global.OOF_INPUTS_ID_RETMOD[var.TOOL]} T{global.OOF_INPUTS_RETMOD_TRIGGER[var.TOOL][1]} S0	;Configure the emergency trigger event
...
; Create the links ------------------------------------------------------------
M98 P"/macros/files/link/create.g" L{"/sys/trigger" ^ global.OOF_INPUTS_TRIGGER[var.TOOL][0] ^ ".g"} D{"/sys/modules/extruders/oof_event.g"} I{null}
M98 P"/macros/files/link/create.g" L{"/sys/trigger" ^ global.OOF_INPUTS_TRIGGER[var.TOOL][1] ^ ".g"} D{"/sys/modules/extruders/oof_event.g"} I{null}
M118 S{"Configured OOF sensor for tool 0"}

; M98 P"/macros/files/link/create.g" L{"/sys/trigger" ^ global.OOF_INPUTS_RETMOD_TRIGGER[var.TOOL][0] ^ ".g"} D{"/sys/modules/extruders/oof_event.g"} I{null}
; M98 P"/macros/files/link/create.g" L{"/sys/trigger" ^ global.OOF_INPUTS_RETMOD_TRIGGER[var.TOOL][1] ^ ".g"} D{"/sys/modules/extruders/oof_event.g"} I{null}
; M118 S{"Configured OOF retraction module for tool 0"}
; -----------------------------------------------------------------------------
