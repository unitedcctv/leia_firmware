...
; Example:
;	M98 P"/sys/modules/extruders/oof_config.g" T0
;------------------------------------------------------------------------------
...
; Create the links ------------------------------------------------------------
M98 P"/macros/files/link/create.g" L{"/sys/trigger" ^ global.OOF_INPUTS_TRIGGER[param.T][0] ^ ".g"} D{"/sys/modules/extruders/oof_event_t"^param.T^".g"} I{null}
M98 P"/macros/files/link/create.g" L{"/sys/trigger" ^ global.OOF_INPUTS_TRIGGER[param.T][1] ^ ".g"} D{"/sys/modules/extruders/oof_event_t"^param.T^".g"} I{null}
M118 S{"Configured OOF sensor for tool "^param.T}

; M98 P"/macros/files/link/create.g" L{"/sys/trigger" ^ global.OOF_INPUTS_RETMOD_TRIGGER[param.T][0] ^ ".g"} D{"/sys/modules/extruders/oof_event_t"^param.T^".g"} I{null}
; M98 P"/macros/files/link/create.g" L{"/sys/trigger" ^ global.OOF_INPUTS_RETMOD_TRIGGER[param.T][1] ^ ".g"} D{"/sys/modules/extruders/oof_event_t"^param.T^".g"} I{null}
