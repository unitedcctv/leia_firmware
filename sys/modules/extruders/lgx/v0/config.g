...
;---------------------------------------------------------------------------------------------
var CURRENT_FILE = "/sys/modules/extruders/lgx/v0/config.g"
...
M98 P"/macros/assert/result.g" R{result} Y"Unable to create extruder heater" F{var.CURRENT_FILE} E12711
M143 H{var.HEATER_ID} S{var.HEATER_MAX_TEMP}	; Max. Temperature of the heater
M98 P"/macros/assert/result.g" R{result} Y"Unable to set max temperature" F{var.CURRENT_FILE} E12712
...
M98 P"/macros/assert/result_accept_warning.g" R{result}  Y"Unable to set heating parameters" F{var.CURRENT_FILE} E12713 ; It is normal to get warning with M307

; Cold-end FAN controlled by temperature
M950 F{var.FAN_COLDEND_ID} C{var.FAN_COLDEND_PORT} 	Q200
M98 P"/macros/assert/result.g" R{result} Y"Unable to create the cold-end fan" F{var.CURRENT_FILE} E12714
...
M98 P"/macros/assert/result.g" R{result} Y"Unable to enable thermostatic mode for the cold-end fan" F{var.CURRENT_FILE} E12715
