...
; editing this file to disable door controls KARL
;---------------------------------------------------------------------------------------------
var CURRENT_FILE = "/sys/modules/doors/config.g"
...
global doorIsLocked = true				; Global variable to save if the door is open or close KARL set to true

; CONFIGURATION ------------------------------------------------------------------------------
; Checking for board disabled board check KARL
...
; Links
M98 P"/macros/files/link/create.g" L"/macros/doors/control.g" D"/sys/modules/doors/set_solenoid.g"

global MODULE_DOORS = 0.1	; Setting the current version of this module

; M98 P"/macros/doors/unlock.g" 	; Unlock doors removed unlock KARL
