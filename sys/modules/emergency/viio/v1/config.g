...
;
;---------------------------------------------------------------------------------------------
var CURRENT_FILE = "/sys/modules/emergency/viio/v1/config.g"
...
M98 P"/macros/files/link/create.g" L{"/sys/trigger" ^ var.EMERGENCY_TRIGGER_ID ^ ".g"} 			D"/sys/modules/emergency/viio/v1/trigger_emergency_door.g"
M98 P"/macros/files/link/create.g" L{"/sys/trigger" ^ var.EMERGENCY_GENERAL_TRIGGER_ID ^ ".g"} 	D"/sys/modules/emergency/viio/v1/trigger_emergency_general.g"
...
M98 P"/sys/modules/emergency/viio/v1/trigger_emergency_door.g"
M98 P"/sys/modules/emergency/viio/v1/read_emergency_general.g"
