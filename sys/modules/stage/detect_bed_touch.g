...
;					assigned.
; -----------------------------------------------------------------------------
var CURRENT_FILE = "/sys/modules/stage/detect_bed_touch.g"
M118 S{"[detect_bed_touch.g] Starting "^var.CURRENT_FILE^" I:"^state.thisInput^" S:"^inputs[state.thisInput].stackDepth}

; Checking global variables and input parameters ------------------------------
; Checking for files first
M98 P"/macros/assert/abort_if_file_missing.g" R{"/sys/modules/stage/detect_bed_touch_slider.g"} F{var.CURRENT_FILE} E16460
M98 P"/macros/assert/abort_if_file_missing.g" R{"/sys/modules/stage/detect_bed_touch_hall.g"} F{var.CURRENT_FILE} E16462
...
if var.LINEAR_SENSOR_INSTALLED
	...
	if var.needCalib
		...
		if (!move.axes[2].homed || move.axes[2].machinePosition < 20)
			...
			G90
		M400
		M98 P"/sys/modules/stage/calibrate_pos_sensor.g" T{var.TOOL}
		M400
		T-1
	M400
M400
...
if var.LINEAR_SENSOR_INSTALLED
	...
	M98 P"/sys/modules/stage/detect_bed_touch_slider.g" T{var.TOOL} X{var.X_POSITION} Y{var.finalProbeYpos} Z{var.Z_POSITION_TOUCH_START_LINEAR} O{var.finalProbeOffset} H{var.INCLUDE_HEADERS} F{var.LOGFILE}
else
    set global.touchBedObstacleThresholds[var.TOOL] = 200
    M98 P"/sys/modules/stage/detect_bed_touch_hall.g" T{var.TOOL} X{var.X_POSITION} Y{var.finalProbeYpos} Z{var.Z_POSITION_TOUCH_START_HALL} O{var.finalProbeOffset}
M400
M598
