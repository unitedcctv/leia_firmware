...
; -----------------------------------------------------------------------------
var CURRENT_FILE = "/sys/modules/stage/detect_bed_touch_slider.g"
...
M98 P"/macros/assert/abort_if_file_missing.g" R{"/sys/modules/stage/calibrate_pos_sensor.g"} F{var.CURRENT_FILE} E16550
