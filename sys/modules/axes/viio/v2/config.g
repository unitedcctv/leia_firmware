...
;------------------------------------------------------------------------------
var CURRENT_FILE = "/sys/modules/axes/viio/v2/config.g"
...
; Gearbox
var GEARBOXES_INSTALLED = fileexists("/sys/modules/axes/viio/v2/_gearboxes_installed.txt")
...
; Creating links:
M98 P"/macros/files/link/create.g" L"/macros/axes/measure_length.g" D"/sys/modules/axes/viio/v2/measure_length.g"
M98 P"/macros/files/link/create.g" L{"/sys/trigger" ^ var.EMERGENCY_TRIGGER_ID ^ ".g"} 	D"/sys/modules/axes/viio/v2/trigger_emergency_probe.g" I{null}
