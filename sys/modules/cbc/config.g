...
;-------------------------------------------------------------------------------------------------------
var CURRENT_FILE = "/sys/modules/cbc/config.g"
...
M98 P"/macros/files/link/create.g" L"/macros/cbc/set_temperature.g" D"/sys/modules/cbc/set_temperature.g"
; Adding to daemon:
;	(!) Using viio/v0 as there are no changes
global cbcForceFansOn = false ; This is needed to test the fans
M98 P"/macros/files/daemon/add.g" F"/sys/modules/cbc/daemon.g"
