...
if(exists(tools[1]) && (global.lastPrintingTemps[1]!= null))
	M568 P1 S{global.lastPrintingTemps[1]} R{global.lastPrintingTemps[1]} A2

M118 S{"setting T0 to "^global.lastPrintingTemps[0]^ "and T1 to "^global.lastPrintingTemps[1]}
;--------------------------------------------------------------------------------
