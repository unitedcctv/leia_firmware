...
; Check the files
M98 P"/macros/assert/abort_if_file_missing.g" R{"/sys/modules/stage/viio/v2/calibrate_pos_sensor.g"} F{var.CURRENT_FILE} E89015
...
; call the test macro
M98 P"/sys/modules/stage/viio/v2/calibrate_pos_sensor.g" T0
M400
